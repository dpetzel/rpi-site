...
- **Static Site Generator:** MkDocs with the built-in `mkdocs` theme
...
3. **Leverage MkDocs built-in features** — use admonitions, code blocks, and other supported Markdown extensions rather than custom solutions.
...
5. **Preserve the theme configuration** — do not change the theme unless instructed.
